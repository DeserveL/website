...
import static com.deservel.website.generator.ProjectConstant.*;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        //genCode("输入表名");
        genCode("attach","comments","contents","logs","metas","options","relationships","users");
    }
    ...
    public static void genModelAndMapper(String tableName) {
        ...
        commentGeneratorConfiguration.setConfigurationType(MY_COMMENT_GENERATOR);
        Properties commentProperties = commentGeneratorConfiguration.getProperties();
        commentProperties.setProperty("suppressDate","true");//阻止**生成的注释包含时间戳，默认为false
